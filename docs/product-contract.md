...
PC-034/035 remain FUTURE. The [adoption guide](facade-contracts.md#complete-frame-execution-adoption)
...
links into ignored specifications or declarations that the work has shipped. Order is convenience
migration, then identity/state/replay qualification. Execution of any later work still requires its
own accepted prerequisite and owner authorization.
