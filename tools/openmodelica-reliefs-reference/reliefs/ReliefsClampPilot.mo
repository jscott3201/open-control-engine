model ReliefsPilot
  Modelica.Blocks.Sources.Constant uOutDamMinSource(k=0.875);
  Modelica.Blocks.Sources.Constant uOutDamMaxSource(k=0.25);
  Modelica.Blocks.Sources.Constant uRetDamMinSource(k=0.75);
  Modelica.Blocks.Sources.Constant uRetDamMaxSource(k=0.125);
