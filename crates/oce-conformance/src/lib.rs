...
pub use driver::{
    CapturedColumn, CapturedTrace, DriveCadence, DriveMode, DriverError, DriverInputReplay,
    DriverOptions, DriverRun, SignalComparison, drive_trace, drive_trace_with_options,
};
