...
pub(crate) const EXPECTED: &[DocExpectation] = &[
    ...
    DocExpectation {
        ...
        counts: &[
            ...
            ("inactive-conditional-node", "error", 1),
            ("malformed-document", "error", 44),
            ("undriven-boundary-output", "warning", 1),
            ("unresolved-reference", "error", 114),
        ],
    ...
    DocExpectation {
        ...
        counts: &[
            ...
            ("grounding-failed", "error", 3),
            ("inactive-conditional-node", "error", 4),
            ("malformed-document", "error", 32),
            ("undriven-boundary-output", "warning", 4),
            ("unresolved-reference", "error", 139),
        ],
    ...
    DocExpectation {
        ...
        counts: &[
            ...
            ("grounding-failed", "error", 3),
            ("inactive-conditional-node", "error", 6),
            ("malformed-document", "error", 30),
            ("undriven-boundary-output", "warning", 4),
            ("unresolved-reference", "error", 125),
        ],
        duplicate_triples: 40,
    },
];
...
pub(crate) const AGGREGATE: CorpusAggregate = CorpusAggregate {
    counts: &[
        ...
        ("inactive-conditional-node", "error", 11),
        ("malformed-document", "error", 944),
        ("non-subset-construct", "error", 81),
        ("undriven-boundary-output", "warning", 131),
        ("unresolved-reference", "error", 2816),
    ],
    unresolved_reference_messages: &[
        ("boundary-input target not found", 304),
        ("boundary-output source not found", 164),
        ("connection source not found", 1174),
        ("connection target not found", 1174),
    ],
    inactive_conditional_messages: &[
        ("connection targets an inactive conditional node", 1),
        (
    ...
    duplicates_by_code: &[
        ...
        ("unresolved-reference", 340),
    ],
    duplicates_total: 425,
};
