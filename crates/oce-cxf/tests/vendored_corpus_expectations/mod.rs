...
pub(crate) const EXPECTED: &[DocExpectation] = &[
    DocExpectation {
        ...
        counts: &[
            ...
            ("unresolved-reference", "error", 89),
        ],
        duplicate_triples: 17,
    },
    DocExpectation {
...
pub(crate) const AGGREGATE: CorpusAggregate = CorpusAggregate {
    counts: &[
        ...
        ("unresolved-reference", "error", 222),
    ],
    unresolved_reference_messages: &[
        ("boundary-input target not found", 65),
        ("boundary-output source not found", 33),
    ...
    duplicates_by_code: &[
        ...
        ("unresolved-reference", 16),
    ],
    duplicates_total: 101,
};
