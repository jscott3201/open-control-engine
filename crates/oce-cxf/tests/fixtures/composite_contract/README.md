...
| `rejected/array_connector.jsonld` | 7 | An active `isArray` connector referenced by a block instance. | `composite/array-connector` (`non-subset-construct`); subject is the connector node `#M.c2.u`. |
